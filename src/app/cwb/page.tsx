...
export default function CWBPage() {
  ...
  useEffect(() => {
    const loadStudios = async () => {
      ...
      // Carrega dados de Curitiba
      const cwbData = getCityData('cwb');
      const studiosWithSlugs = cwbData.map((studio, index) => {
        const existingSlugs = cwbData
          .slice(0, index)
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col items-center justify-center min-h-[60vh]">
            ...
            <p className="text-gray-500">Encontrando os melhores estúdios de Pilates em Curitiba</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-gray-800">
            Estúdios de Pilates em Curitiba
          </h1>
          <CitySelector currentCity="cwb" className="ml-4" />
        </div>
